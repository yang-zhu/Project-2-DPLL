...
markers = (['o', '<', '>', '^', 'v', 's', 'd']*len(stats_combined))[:len(stats_combined)]
sns.lineplot(x='Instances', y='Time', hue='Configuration', data=stats_dict, markers=markers, style="Configuration", dashes=False, palette='bright')
